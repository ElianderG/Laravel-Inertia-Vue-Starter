...
<template>
    <!-- overlay -->
     ...
     class="fixed inset-0 z-40 bg-slate-800 bg-opacity-50"></div>
        ...
        <nav class="p-6 mx-auto max-w-screen-lg flex items-center justify-between">
            ...
            <div class="flex items-center space-x-6">
                ...
                <!-- user dropdown menu -->
                 ...
                 bg-slate-800 text-white rounded-lg border-slate-100
                 border overflow-hidden w-40"
                 >
                    <Link class="block w-full px-6 py-3
